<template lang="pug">
  .container-fluid.bg-bclr.bg-blue
    .row
      .col-12.text-light
        .section
          h2 How to Read &ndash; Primer

          blockquote.blockquote.text-center
            p.mb-0 More to be desired are they than gold, even much fine gold.
